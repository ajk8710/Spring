...
<td><f:input type="date" path="dob" value="${retrievedEmployee.dob}"/></td>  <!-- value="<%=java.time.LocalDate.now() %>" -->
...
<tr>
<td>Phone Number:</td>
<td><f:input type="text" path="phoneNumber" value="${retrievedEmployee.phoneNumber}"/></td>
<td><f:errors path="phoneNumber" cssClass="error"/></td>
</tr>

<tr>
<td>Email:</td>
<td><f:input type="text" path="email" value="${retrievedEmployee.email}"/></td>
...
<tr>
<td>Address Line1:</td>
<td><f:input type="text" path="address.addressLine1" value="${retrievedEmployee.address.addressLine1}"/></td>
<td><f:errors path="address.addressLine1" cssClass="error"/></td>
</tr>

<tr>
<td>Address Line2::</td>
<td><f:input type="text" path="address.addressLine2" value="${retrievedEmployee.address.addressLine2}"/></td>
<td><f:errors path="address.addressLine2" cssClass="error"/></td>
</tr>

<tr>
<td>City:</td>
<td><f:input type="text" path="address.city" value="${retrievedEmployee.address.city}"/></td>
<td><f:errors path="address.city" cssClass="error"/></td>
</tr>

<tr>
<td>State:</td>
<td><f:input type="text" path="address.state" value="${retrievedEmployee.address.state}"/></td>
<td><f:errors path="address.state" cssClass="error"/></td>
</tr>

<tr>
<td>Country:</td>
<td><f:input type="text" path="address.country" value="${retrievedEmployee.address.country}"/></td>
...
<c:forEach items="${employees}" var="e">
	<tr>
	   ...
	   <td> <a href="updateEmployee?empId=${e.empId}">Update</a> | <a href="deleteEmployee?empId=${e.empId}">Delete</a> </td>  <!-- empId should match name of class property -->
	</tr>
</c:forEach>
