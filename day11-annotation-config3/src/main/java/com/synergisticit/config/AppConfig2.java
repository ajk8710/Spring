...
public class AppConfig2 {
    ...
    @Bean(name = "employeeDao")  // bean can have a name. If not specified, name of class is assigned as a name
    ...
    @Bean(name = "employeeDao2")  // bean can have a name. If not specified, name of class is assigned as a name
