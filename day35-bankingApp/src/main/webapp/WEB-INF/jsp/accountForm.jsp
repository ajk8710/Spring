        ...
        <c:forEach items="${accountTypes}" var="t">
            <c:choose>
                <c:when test="${selectedAccountType.equals(t)}">
                    <f:radiobutton path="accountType" value="${t}" label="${t}" checked="true" class="form-check-input"></f:radiobutton>
                </c:when>
                <c:otherwise>
                    <f:radiobutton path="accountType" value="${t}" label="${t}" class="form-check-input"></f:radiobutton>
                </c:otherwise>
            </c:choose>
        </c:forEach>
    </td>
