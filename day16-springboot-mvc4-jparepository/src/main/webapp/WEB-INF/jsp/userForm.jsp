...
<f:form action="saveUser" modelAttribute="user">  <!-- modelAttribute is name of class starting with lower case -->
<table border="1">
<tr>  <!-- table row -->
<td>User Id:</td> <td><f:input path="userid" value="${retrievedUser.userid}"/></td>  <!-- table data (table columns) -->
</tr>
